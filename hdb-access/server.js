...
const cds = require("@sap/cds"); //Initialize Express App for XSA UAA and HDBEXT Middleware 
...
global.__uaa = process.env.UAA_SERVICE_NAME; //logging 
var logging = require("@sap/logging"); 
var appContext = logging.createAppContext(); //Initialize Express App for XS UAA and HDBEXT Middleware 
